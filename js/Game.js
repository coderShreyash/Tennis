...
export class Game {
  constructor() {
    ...
    this.bgLinearGradient.addColorStop(1, "blue");
    ...
    this.bgGradient.addColorStop(0, '#ffffff');
    this.bgGradient.addColorStop(1, '#ffffff');
    ...
    this.playImage.src = 'images/scoreboard.png';
